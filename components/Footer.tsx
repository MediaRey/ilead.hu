        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/future-ready-executive-program" className="text-gray-700 hover:text-orange transition-colors">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.linkedin.com/company/i-lead-institute-%C4%8Desko" className="text-burgundy hover:text-orange transition-colors">
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
