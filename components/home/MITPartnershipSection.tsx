          ...
          <div>
            ...
            <div className="mt-8">
              <a
                ...
                className="inline-block px-8 py-3 rounded-full font-medium transition-all duration-300 border-0 bg-orange text-white hover:bg-navy-black hover:text-white"
              >
